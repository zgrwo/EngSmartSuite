...
def regression_analysis(req: AnalysisRequest) -> AnalysisResult:
    ...
    try:
        ...
        return AnalysisResult(task="regression", status="error", messages=[str(e)])
...
def grid_search(req: AnalysisRequest) -> AnalysisResult:
    ...
    try:
        ...
        return AnalysisResult(task="grid_search", status="error", messages=[str(e)])
