...
- v1.4.0：42 个分析方法，982 项测试（口径：`pytest tests/ --collect-only`，2026-09-21 在 `v1.4.0` worktree 复核；同口径 `v1.3.1` = 954，`main` = 1346 （2026-09-21 两轮审查修复后重测）），覆盖率 90.04%（v1.4.0 CI 实测），4 层测试防线 + 文档数值对账门禁。
